...
int op1();			//function to perform on user's choise 1
int op2();			//function to perform on user's choise 2
int op3();			//function to perform on user's choise 3
int op4(int);		//function to perform on user's choise 4
int op5();			//function to perform on user's choise 5
int other();		//function to perform on user's wrong choise

void main()
{
	int num_sel, on = 1, count=0, check_scan=1;
		//num_sel - user coise
		//on - loop condition
